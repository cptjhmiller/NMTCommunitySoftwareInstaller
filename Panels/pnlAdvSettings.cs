...
{
    public partial class pnlAdvSettings : BasePanel
    {
        ...
        public override bool Execute()
        {
            ...
            if (FtpCommands.TestFTPserver(txtServerName.Text, txtUserName.Text, txtPassword.Text))
            {
                ...
                Settings.Default.FTPSubFolder = txtFTPSubFolder.Text;
                Settings.Default.WebserverSubFolder = txtWebserverSubFolder.Text;
        ...
        private void pnlAdvSettings_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                ...
                txtFTPSubFolder.Text = Settings.Default.FTPSubFolder;
                txtWebserverSubFolder.Text = Settings.Default.WebserverSubFolder;
        ...
        private void cbxHardwareType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbxHardwareType.SelectedIndex > 0)
            {
                ...
                txtFTPSubFolder.Text = det.DefaultFTPSubFolder;
                txtWebserverSubFolder.Text = det.DefaultWebserverSubFolder;
            }
        }
